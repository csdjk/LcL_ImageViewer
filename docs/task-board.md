...
|---|---|---|---|---|---|---|
| IV-TA-01 | 轻量贴图检查首轮：DDS、动画预算、自动刷新与视图锁定 | IN_PROGRESS | Codex / codex/ta-foundation | 用户授权 / 6934031 | 见 `docs/轻量贴图检查优化计划.md` | DDS标准样例、内存边界、保存刷新与竞态测试；双主题双尺寸实机、release及main复验；本地提交不发布 |
