...
|---|---|---|---|---|---|---|
| IV-P1-N15 | 左右切图按钮圆形化 | REVIEW | ChatGPT-AgentDock | 用户本轮要求 / v0.5.0 当前main | `crates/iv-viewer/src/{ui.rs,app.rs}`, `tools/ui-qa/**`, `docs/ui-qa/**` | 两侧按钮背景和玻璃遮罩为真圆形；箭头/点击/禁用/显隐保持；测试+实机截图+本地main复验，不发布 |
