...
IV-P1-N09 DONE：按用户澄清，设置标题只移动查看器内部弹窗，不再移动原生主窗口。40tests/check/双构建及当前Release实机复验通过。P1保持ACTIVE，NEXT为IV-P1-01。

## 用户授权发布 v0.3.0

2026-09-15：IV-REL-030 DONE，文档配图、打包和公开Release完成，下载hash已复验。此次交付按用户明确要求执行；不把P1多DPI/性能等未完成验收标为通过。后续仍为IV-P1-01。


## v0.3.1 授权发布

2026-09-15：REL-031 DONE，整合加载优化及安装器注册/D盘修复。主线测试、隔离安装/载荷验证、正式包和公开下载核验通过。P1长期门禁继续保留，不扩大已测范围。


## v0.4.0 授权发布

2026-09-16：IV-REL-040 DONE，AVIF动画、子目录/相对路径、透明画布/图片边界与缩略图增量正式发布；静态CRT、许可随包、安装/ZIP实机和公开下载hash核验通过。P1长期门禁保持，不自动改变阶段。

## v0.5.0 授权发布

2026-09-20：IV-REL-050 DONE，置顶、背景调色板与README功能图解已正式发布；构建、包体、隔离安装、公开下载及图片核验通过。P1长期门禁不自动改变。
